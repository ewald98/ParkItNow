...
import kotlinx.android.synthetic.main.item_car_added.view.*

class AddedCarsRecycleViewAdapter(
        private val parkedCars: List<ParkedCar>,
        private val onDeleteClick: (ParkedCar) -> (Unit)
): RecyclerView.Adapter<AddedCarsRecycleViewAdapter.CarViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CarViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_car_added, parent, false)
